...
O projeto está configurado para deploy automático na OCI usando Docker, nginx e GitHub Actions.
...
#### Trigger do Deploy:
- Push para branch `freezer-project`
...
```bash
curl -o docker-compose.yml https://raw.githubusercontent.com/guelfi/Barbear.IA/freezer-project/docker-compose.yml
```
...
- **Com proxy**: `http://your-domain.com` (se configurado nginx)
- **Porta**: 3500
- **Protocolo**: HTTP

### 🔒 Segurança e Performance

- **Segurança**: Aplicação roda em container isolado com headers de segurança
- **Performance**: Build otimizado com multi-stage e compressão gzip
- **Disponibilidade**: Health checks e restart automático
- **Monitoramento**: Logs centralizados e métricas de container
